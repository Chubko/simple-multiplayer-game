...
const Orb = require("./classes/Orb");//make an orbs array hat will host all 500/5000 not player orbs
...
io.on("connect", socket => {
    ...
    socket.on("init", (playerObj, ackCallback) => {
        ...
        //even that runs on join that does init game stuff
...
function initGame() {
    //loop defaultNumberOfOrbs times, and push a new Orb() onto orbs array
...
function getLeaderBoard() {
    return players.map(curPlayer => curPlayer.playerData ? {
